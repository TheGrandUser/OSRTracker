...
public class AppDbContext : DbContext
{
   ...
   public DbSet<CampaignSettings> CampaignSettings
   {
      get; set;
   }
   ...
   public DbSet<ClassDefinition> ClassDefinitions
   {
      get; set;
   }
   public DbSet<CurrencyDefinition> CurrencyDefinitions
   {
      get; set;
   }
   public DbSet<Delve> Delves
   {
      get; set;
   }
   public DbSet<GeneralXPAward> GeneralXPAwards
   {
      get; set;
   }
   public DbSet<MonsterEntry> MonsterEntries
   {
      get; set;
   }
   ...
   public DbSet<SessionDelve> SessionDelves
   {
      get; set;
   }
   public DbSet<TreasureEntry> TreasureEntries
   {
      get; set;
   }
   ...
   protected override void OnModelCreating(ModelBuilder modelBuilder)
   {
      ...
      modelBuilder.Entity<ClassDefinition>(entity =>
      {
         ...
         entity.OwnsMany(x => x.LevelXP)
               .ToJson();

         entity.OwnsMany(x => x.KeyAttributes)
               .ToJson();
      });
